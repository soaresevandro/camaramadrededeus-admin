...
function renderTable() {
  ...
  tableBody.innerHTML = noticias
    .filter((noticia) => noticia.tipo === "N") // filtra apenas tipo Noticias
    .map(
      (noticia) => `
      <tr>
        ...
        <td class="descricao-cell">${escapeHtml(noticia.conteudo)}</td>
        <td class="descricao-cell">${escapeHtml(noticia.detalhamento)}</td>
